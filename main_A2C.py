...
if __name__ == '__main__':
    ...
    monitor_path = 'C:\\Users\\jules\\Documents\\SMU\\code2\\A2C\\reward_A2C'
    num_procs = 27
    num_ts = 210_000_000
    ...
    checkpoint = CheckpointCallback(save_freq=1_000_000 // env.num_envs + 1,
                                    save_path='C:\\Users\\jules\\Documents\\SMU\\code2\\A2C\\',
                                    name_prefix="a2c_bot_",
                                    verbose=1)

    # learner = A2C("MlpPolicy", env, verbose=3, device='cuda')
    learner = A2C.load(path='C:\\Users\\jules\\Documents\\SMU\\code2\\A2C2\\a2c_bot__19000494_steps',
                       env=env,
                       device='cuda',
                       n_epochs=1,
                       target_kl=0.02 / 1.5,
